            ...
            <div class="card" style="border: none;">
                <div class="card" style="border: none;">
                    ...
                    <ul class="nav nav-tabs mb-3" role="tablist">
                        <li class="nav-item"> 
                            <a class="nav-link active" id="basic-tab" data-toggle="tab" href="#change-password" rol
                                role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down"><i
                                        class="fas fa-key tab-icon"></i><b> Change Password</b></span></a> </li>
                    </ul>
                    <!-- Tab panes -->
                    <div class="tab-content tabcontent-border">
                        <div class="tab-pane p-20 active" id="changepass" role="tabpanel">
                        <?php
				$query = "SELECT * FROM basic WHERE id='$s'";
    $query_run = mysqli_query($db, $query);
