...
<body>
    ...
    <div class="container-fluid">
        <div class="filter-section">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group mb-0">
                        <label for="batchSelectt">Select Batch:</label>
                        <select class="form-control" id="batchSelectt">
                            <option value="">All Years</option>
                            ...
                            <option value="2023-2025">2023-25</option>
                            <option value="2024-2026">2024-26</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="card-header bg-white">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="export-buttons">
                        <button class="dbtn  btn-primary btn-sm export-csv">Export CSV</button>
                        <button class="dbtn  btn-success btn-sm export-excel" style="background:#21a86f;">Export Excel</button>
                        <button class="dbtn  btn-warning btn-sm export-pdf" style="background:#d74747;">Export PDF</button>
                    </div>
                </div>
            </div>
            <div class="card-body">
    ...
    <script>
        $(document).ready(function () {
            ...
            //  batch selection
            $('#batchSelectt').on('change', function () {
