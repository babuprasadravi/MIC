...
if (isset($_POST['update_basic'])) {
  ...
  if (!empty($_FILES['pphoto']['name'])) {
    ...
    $filePath = $f; // Retain existing photo if no new file is uploaded
}
...
if (!empty($_FILES['fphoto']['name'])) {
    ...
    if (!empty($f2) && file_exists($f2)) {
        unlink($f2);
    }
    
    move_uploaded_file($file_tmp, $filePath);
} else {
    $filePath = $f2; // Retain existing photo if no new file is uploaded
}
...
if (!empty($_FILES['mphoto']['name'])) {
    ...
    if (!empty($f3) && file_exists($f3)) {
        unlink($f3);
    }
    
    move_uploaded_file($file_tmp, $filePath);
} else {
    $filePath = $f3; // Retain existing photo if no new file is uploaded
}

if (!empty($_FILES['gphoto']['name'])) {
    ...
    if (!empty($f4) && file_exists($f4)) {
        unlink($f4);
    }
    
    move_uploaded_file($file_tmp, $filePath);
} else {
    $filePath = $f4; // Retain existing photo if no new file is uploaded
}

if (!empty($_FILES['saadhar']['name'])) {
    ...
    if (!empty($f5) && file_exists($f5)) {
        unlink($f5);
    }
    
    move_uploaded_file($file_tmp, $filePath);
} else {
    $filePath = $f5; // Retain existing photo if no new file is uploaded
}

if (!empty($_FILES['span']['name'])) {
